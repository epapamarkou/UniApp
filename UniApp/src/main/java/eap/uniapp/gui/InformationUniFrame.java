...
public class InformationUniFrame extends javax.swing.JFrame {

    /**
     * Creates new form InformationUniFrame
     */
    public InformationUniFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton3.setText("List of Universities");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformationUniFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformationUniFrame().setVisible(true);
            }
        });
    }
